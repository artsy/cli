...
describe("scheduled:facilitate-incident-review with facilitatorEmail set", () => {
  test
    .nock("https://slack.com/api", api =>
      api
        .post("/users.lookupByEmail", /email=neo%40matrix.com/)
        .reply(200, {
          ok: true,
          user: {
            id: "neo",
    ...
    .stdout()
    .command(["scheduled:facilitate-incident-review", "--facilitatorEmail=neo@matrix.com"])
    .it("returns Slack-formatted upcoming facilitation reminder message", ctx => {
