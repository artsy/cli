...
export const acronymMap: AcronymMap = {
  ...
  "CMS": "Content Management System (cms.artsy.net; where Gallery partners update their profile)",
  ...
  "EOY/EOD": "End of year / end of day ",
  "FWIW": "For what it’s worth",
  "GDPR": "General Data Protection Regulation",
  "GMV": "Gross Merchandise Value",
  "GRC": "Gallery Resource Center",
  "GRCD": "Gallery Relations Commission Dashboard ",
  "GSP": "Global Strategic Partnerships (Outdated team name → has become Large Accounts, Fairs)",
  "HQ": "Headquarter",
  ...
  "PII": "Personally identifiable information (e.g. name, email, birthdate, etc.)",
  "P&C": "People & Culture",
